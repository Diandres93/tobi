...
import 'dash_board_seller_model.dart';
export 'dash_board_seller_model.dart';

class DashBoardSellerWidget extends StatefulWidget {
  const DashBoardSellerWidget({
    Key? key,
    this.userId,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UserRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRow> dashBoardSellerUserRowList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final dashBoardSellerUserRow = dashBoardSellerUserRowList.isNotEmpty
            ? dashBoardSellerUserRowList.first
            : null;
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    5.0),
                                                        child: AutoSizeText(
                                                          'Cel:${dashBoardSellerUserRow?.userPhone}'
                                                              .maybeHandleOverflow(
                                                            maxChars: 12,
                                                            replacement: '…',
                                                          ),
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    5.0),
                                                        child: AutoSizeText(
                                                          'email:${dashBoardSellerUserRow?.userEmail}'
                                                              .maybeHandleOverflow(
                                                            maxChars: 12,
                                                            replacement: '…',
                                                          ),
                                    ...
                                    if (dashBoardSellerUserRow?.seller ?? true)
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 5.0, 0.0, 0.0),
                                        child: Container(
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return wrapWithModel(
                                                                ...
                                                                child:
                                                                  ...
                                                                  key: Key(
                                                                    'Keyco3_${listViewCouponRow.couponId}',
                                                                  ),
                                                                  cuponId:
                                                                      listViewCouponRow
                                                                          .couponId,
                                                              ...
                                                              itemBuilder: (context,
                                                                ...
                                                                return wrapWithModel(
                                                                  ...
                                                                  child:
                                                                      CouponCardMainWidget(
                                                                    key: Key(
                                                                      'Keykf6_${listViewCouponRow.couponId}',
                                                                    ),
                                                                    cuponId:
                                                                        listViewCouponRow
                                                                            .couponId,
