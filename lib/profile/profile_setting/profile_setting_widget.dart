  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UserRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRow> profileSettingUserRowList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final profileSettingUserRow = profileSettingUserRowList.isNotEmpty
            ? profileSettingUserRowList.first
            : null;
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                          ...
                                          Container(
                                            ...
                                            child: Container(
                                              ...
                                              child: CachedNetworkImage(
                                                ...
                                                fadeOutDuration:
                                                    Duration(milliseconds: 500),
                                                imageUrl: profileSettingUserRow!
                                                    .userAvatar!,
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    5.0),
                                                        child: AutoSizeText(
                                                          'Cel:${profileSettingUserRow?.userPhone}'
                                                              .maybeHandleOverflow(
                                                            maxChars: 12,
                                                            replacement: '…',
                                                          ),
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    5.0),
                                                        child: AutoSizeText(
                                                          'email:${profileSettingUserRow?.userEmail}'
                                                              .maybeHandleOverflow(
                                                            maxChars: 12,
                                                            replacement: '…',
                                                          ),
                                    ...
                                    if (profileSettingUserRow?.seller ?? true)
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 5.0, 0.0, 0.0),
                                        child: Container(
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return wrapWithModel(
                                                                ...
                                                                child:
                                                                  ...
                                                                  key: Key(
                                                                    'Keyd3d_${listViewCouponRow.couponId}',
                                                                  ),
                                                                  cuponId:
                                                                      listViewCouponRow
                                                                          .couponId,
                                                              ...
                                                              itemBuilder: (context,
                                                                ...
                                                                return wrapWithModel(
                                                                  ...
                                                                  child:
                                                                      CouponCardMainWidget(
                                                                    key: Key(
                                                                      'Keyad1_${listViewCouponRow.couponId}',
                                                                    ),
                                                                    cuponId:
                                                                        listViewCouponRow
                                                                            .couponId,
