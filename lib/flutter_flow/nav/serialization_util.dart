  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case CategoryCouponRow:
            return CategoryCouponRow(data);
          case OrderRow:
            return OrderRow(data);
          case OrderCouponRow:
            return OrderCouponRow(data);
          case CartRow:
            return CartRow(data);
          case CountryRow:
          ...
          case TransactionHistoryRow:
            return TransactionHistoryRow(data);
          case CuponsFavoritesRow:
            return CuponsFavoritesRow(data);
          case RoleRow:
            return RoleRow(data);
          case ProductRow:
          ...
          case CategoryProductRow:
            return CategoryProductRow(data);
          case UserRow:
            return UserRow(data);
          case SubcategoryCouponRow:
            return SubcategoryCouponRow(data);
          case ReviewRow:
          ...
          case ShippingRow:
            return ShippingRow(data);
          case NotificationRow:
            return NotificationRow(data);
          case ItemRow:
            return ItemRow(data);
          case ItemCuponRow:
            return ItemCuponRow(data);
          default:
            return null;
        }
