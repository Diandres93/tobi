...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF3F0A74);
  late Color tertiary = const Color(0xFF8836BF);
  late Color alternate = const Color(0xFFEF7D35);
  late Color primaryText = const Color(0xFF3F0A74);
  late Color secondaryText = const Color(0xFF050101);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFB150F2);
  late Color accent1 = const Color(0xFF3F0A73);
  late Color accent2 = const Color(0xFFF29D35);
  late Color accent3 = const Color(0x4C050101);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFF3F0A74);
}
